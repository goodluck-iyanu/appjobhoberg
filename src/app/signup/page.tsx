...
import { ArrowLeft, ShieldCheck, Sparkles, CheckCircle } from '@/components/icons'
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#86868b] text-[15px] mt-2 max-w-sm mx-auto">
            Get instant access to verified remote opportunities with Google.
          </p>
        </div>
        ...
        <div className="bg-white border border-[#d2d2d7]/70 rounded-3xl p-6 sm:p-10 shadow-sm">
          ...
          >
            ...
            <span>{loading ? 'Connecting Google...' : 'Sign up with Google'}</span>
          </button>
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 space-y-3 text-[13px] text-[#86868b]">
            <div className="flex items-center gap-2.5">
              ...
              <span>Free forever basic job search &amp; applications</span>
            </div>
            <div className="flex items-center gap-2.5">
              <ShieldCheck className="w-4 h-4 text-[#e02424] shrink-0" />
              <span>Verified opportunities curated by Hoberg Digital Agency</span>
            </div>
            <div className="flex items-center gap-2.5">
              <Sparkles className="w-4 h-4 text-amber-500 shrink-0" />
              <span>Bookmark &amp; track your remote career applications</span>
            </div>
          </div>
