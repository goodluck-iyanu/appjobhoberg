...
import { CheckCircle, AlertCircle, Clock, X, Info } from 'lucide-react'
...
export function ToastProvider({ children }: { children: React.ReactNode }) {
  ...
  // Pure client URL param inspection (100% safe for static page generation)
  useEffect(() => {
    ...
    try {
      ...
      } else if (params.get('toast') === 'login_success') {
      ...
      console.error('Toast search params listener note:', e)
    }
  }, [addToast])
